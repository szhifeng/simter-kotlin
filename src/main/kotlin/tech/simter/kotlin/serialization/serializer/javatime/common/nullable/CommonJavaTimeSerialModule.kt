...
import tech.simter.kotlin.serialization.serializer.javatime.iso.nullable.IsoLocalDateSerializer
import tech.simter.kotlin.serialization.serializer.javatime.iso.nullable.IsoLocalTimeSerializer
import tech.simter.kotlin.serialization.serializer.javatime.iso.nullable.IsoMonthDaySerializer
import tech.simter.kotlin.serialization.serializer.javatime.iso.nullable.IsoYearMonthSerializer
import java.time.*
...
val CommonJavaTimeSerialModule: SerialModule = serializersModuleOf(mapOf<KClass<*>, KSerializer<*>>(
  OffsetDateTime::class to CommonOffsetDateTimeSerializer,
